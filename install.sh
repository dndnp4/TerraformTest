...
sed -i 's/password_here/wlstjd11!/g' /var/www/html/wp-config.php
sed -i 's/localhost/test.cenvguenpdcx.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
